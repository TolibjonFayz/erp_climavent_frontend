// Cascading location data: republic -> region (viloyat) -> district (tuman).
// Exposed as factories so every label runs through the i18n translator `t`.

export function createLocationData(t) {
  return {
  ozbekiston: [
    {
...
export function createRepublicOptions(t) {
  return [
